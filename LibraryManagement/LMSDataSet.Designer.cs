...
namespace LibraryManagement {
    ...
    public partial class LMSDataSet : global::System.Data.DataSet {
        ...
        public partial class BookRecordDataTable : global::System.Data.TypedTableBase<BookRecordRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public BookRecordRow AddBookRecordRow(string isbn, string name, string author, string year, string price, string quantity) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public BookRecordRow FindByisbn(string isbn) {
        ...
        public partial class BookRecordRow : global::System.Data.DataRow {
            ...
            public string isbn {
                get {
                    return ((string)(this[this.tableBookRecord.isbnColumn]));
                }
                set {
                    this[this.tableBookRecord.isbnColumn] = value;
                }
            }
            ...
            public string name {
                get {
                    return ((string)(this[this.tableBookRecord.nameColumn]));
                }
                set {
                    this[this.tableBookRecord.nameColumn] = value;
                }
            }
            ...
            public string author {
                get {
                    return ((string)(this[this.tableBookRecord.authorColumn]));
                }
                set {
                    this[this.tableBookRecord.authorColumn] = value;
                }
            }
            ...
            public string year {
                get {
                    return ((string)(this[this.tableBookRecord.yearColumn]));
                }
                set {
                    this[this.tableBookRecord.yearColumn] = value;
                }
            }
            ...
            public string price {
                get {
                    return ((string)(this[this.tableBookRecord.priceColumn]));
                }
                set {
                    this[this.tableBookRecord.priceColumn] = value;
                }
            }
            ...
            public string quantity {
                get {
                    return ((string)(this[this.tableBookRecord.quantityColumn]));
                }
                set {
                    this[this.tableBookRecord.quantityColumn] = value;
                }
            }
        }
...
namespace LibraryManagement.LMSDataSetTableAdapters {
    ...
    public partial class BookRecordTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[BookRecord] WHERE (([isbn] = @Original_isbn) AND ([name] = @Or" +
                "iginal_name) AND ([author] = @Original_author) AND ([year] = @Original_year) AND" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[BookRecord] ([isbn], [name], [author], [year], [price], [quant" +
                "ity]) VALUES (@isbn, @name, @author, @year, @price, @quantity);\r\nSELECT isbn, na" +
                "me, author, year, price, quantity FROM BookRecord WHERE (isbn = @isbn)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[BookRecord] SET [isbn] = @isbn, [name] = @name, [author] = @author, [year] = @year, [price] = @price, [quantity] = @quantity WHERE (([isbn] = @Original_isbn) AND ([name] = @Original_name) AND ([author] = @Original_author) AND ([year] = @Original_year) AND ([price] = @Original_price) AND ([quantity] = @Original_quantity));
SELECT isbn, name, author, year, price, quantity FROM BookRecord WHERE (isbn = @isbn)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LibraryManagement.Properties.Settings.Default.LMSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT isbn, name, author, year, price, quantity FROM dbo.BookRecord";
        ...
        public virtual int Fill(LMSDataSet.BookRecordDataTable dataTable) {
        ...
        public virtual LMSDataSet.BookRecordDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LMSDataSet.BookRecordDataTable dataTable = new LMSDataSet.BookRecordDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LMSDataSet.BookRecordDataTable dataTable) {
        ...
        public virtual int Delete(string Original_isbn, string Original_name, string Original_author, string Original_year, string Original_price, string Original_quantity) {
        ...
        public virtual int Insert(string isbn, string name, string author, string year, string price, string quantity) {
            if ((isbn == null)) {
        ...
        public virtual int Update(string isbn, string name, string author, string year, string price, string quantity, string Original_isbn, string Original_name, string Original_author, string Original_year, string Original_price, string Original_quantity) {
            if ((isbn == null)) {
                throw new global::System.ArgumentNullException("isbn");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string author, string year, string price, string quantity, string Original_isbn, string Original_name, string Original_author, string Original_year, string Original_price, string Original_quantity) {
            return this.Update(Original_isbn, name, author, year, price, quantity, Original_isbn, Original_name, Original_author, Original_year, Original_price, Original_quantity);
        }
    }
